...
1 修复mysql可能无法成功安装的bug

2 升级httpd至2.2.26,升级tengine至1.5.2

3 修复重复安装可能无法正确安装的bug

4 修复CentOS5/RHEL5下pureftp可能无法成功安装的bug

5 默认禁用部分php危险函数，提升系统安全性

6 更新php5.2 fpm启动控制脚本，增加status选项
